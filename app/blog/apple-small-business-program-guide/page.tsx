    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-6 py-12">
        ...
        <article className="mt-6 space-y-6 text-zinc-300 leading-relaxed">
          <header>
            <h1 className="text-4xl font-bold text-zinc-100 leading-tight">Apple App Store 30% vs 15%: The Complete Small Business Program Guide</h1>
            <p className="mt-3 text-sm text-zinc-500">Published August 8, 2026 · 9 min read</p>
          </header>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">The Basic Rule (And Why It&apos;s Not That Simple)</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">How the Threshold Is Actually Measured</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">Revenue Scenarios: What SBP Is Actually Worth</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">Strategic Considerations at the Boundary</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">What SBP Does Not Cover</h2>
          <p>
