    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-6 py-12">
        ...
        <article className="mt-6 space-y-6 text-zinc-300 leading-relaxed">
          <header>
            <h1 className="text-4xl font-bold text-zinc-100 leading-tight">Google Play Brazil&apos;s 35% Withholding Tax: A Deep Dive for Foreign Developers</h1>
            <p className="mt-3 text-sm text-zinc-500">Published August 8, 2026 · 11 min read</p>
          </header>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">The Three Layers of Brazilian Digital Tax</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">The HK vs Non-HK Entity Difference: An Explicit Example</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">Why Google Play Treats Brazil Differently from Apple</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">The Restructuring Question: Is It Worth Moving Entity?</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">Practical Playbook for Indie Developers</h2>
          <p>
          ...
          <h2 className="text-2xl font-semibold text-zinc-100 pt-4">The Bottom Line</h2>
          <p>
