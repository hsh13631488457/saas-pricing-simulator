    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <article className="mt-6 space-y-5 sm:space-y-6 text-sm sm:text-base text-zinc-300 leading-relaxed">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-zinc-100">Privacy Policy</h1>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">1. Information We Do Not Collect</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">2. Server Logs</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">3. Cookies &amp; Local Storage</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">4. Third-Party Services</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">5. Children&apos;s Privacy</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">6. Changes to This Policy</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">7. Contact</h2>
          <p>
