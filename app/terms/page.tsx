    ...
    <div className="min-h-screen bg-slate-900 text-slate-100 flex flex-col">
      ...
      <main className="flex-1 max-w-3xl w-full mx-auto px-4 sm:px-6 py-8 sm:py-12">
        ...
        <article className="mt-6 space-y-5 sm:space-y-6 text-sm sm:text-base text-zinc-300 leading-relaxed">
          <div>
            <h1 className="text-2xl sm:text-3xl font-bold text-zinc-100">Terms of Service</h1>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">1. Purpose of the Service</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">2. No Professional Advice</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">3. Accuracy of Data</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">4. Permitted Use</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">5. Intellectual Property</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">6. Limitation of Liability</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">7. Modifications to the Service</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">8. Changes to These Terms</h2>
          <p>
          ...
          <h2 className="text-lg sm:text-xl font-semibold text-zinc-100 pt-4">9. Governing Law</h2>
          <p>
